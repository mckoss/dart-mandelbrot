...
$$.IsolateSample = {"":
 ...
 super: "Object",
 ready$0: function() {
  $.document().query$1('#appTitle').set$text('Hello, isolates.');
  var t1 = $.toString($.IsolateSample_isVm());
  $.document().query$1('#vmStatus').set$text(t1);
  var replyElement = $.document().query$1('.isolateMain .replyText');
  this.createIsolate$1('A');
  this.createIsolate$1('B');
  for (t1 = $.iterator($.document().queryAll$1('.sendButton')); t1.hasNext$0() === true; ) {
    $.add$1(t1.next$0().get$on().get$click(), new $.IsolateSample_ready_anon(this, replyElement));
  }
  this.chirpPort.receive$1(new $.IsolateSample_ready_anon0(replyElement));
 },
 createIsolate$1: function(name$) {
  this.spawnDomIsolate$2($.window(), 'isolateEventLoop').then$1(new $.IsolateSample_createIsolate_anon(this, name$));
 }
};
...
$$.IsolateSample_ready_anon = {"":
 ["this_1", "replyElement_0"],
 super: "Closure",
 $call$1: function(e) {
  this.replyElement_0.set$text('waiting for reply...');
  var buttonText = e.get$currentTarget().get$value();
  var isolateName = $.index(buttonText, $.sub($.get$length(buttonText), 1));
  var message = $.makeLiteralMap(['id', 'greeting', 'args', [$.document().query$1('#greetingText').get$value()]]);
  $.index(this.this_1.get$ports(), isolateName).call$1(message).then$1(new $.IsolateSample_ready_anon1(this.replyElement_0));
 }
};

$$.IsolateSample_ready_anon1 = {"":
 ["replyElement_2"],
 super: "Closure",
 $call$1: function(msg) {
  this.replyElement_2.set$text(msg);
 }
};

$$.IsolateSample_ready_anon0 = {"":
 ["replyElement_3"],
 super: "Closure",
 $call$2: function(message, replyTo) {
  this.replyElement_3.set$text(message);
 }
};
...
$$.IsolateSample_createIsolate_anon = {"":
 ["this_1", "name_0"],
 super: "Closure",
 $call$1: function(sendport) {
  sendport.send$2($.makeLiteralMap(['id', 'init', 'args', [this.name_0, this.this_1.get$chirpPort().toSendPort$0()]]), null);
  $.indexSet(this.this_1.get$ports(), this.name_0, sendport);
 }
};
...
$.IsolateSample_main = function() {
  $.IsolateSample$().ready$0();
};
...
$.IsolateSample$ = function() {
  var t1 = $.HashMapImplementation$();
  return new $.IsolateSample($._ReceivePortFactory_ReceivePort(), t1);
};
